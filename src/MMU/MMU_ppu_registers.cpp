...
namespace GB {
void MMU::setWindowXRegister(uint8_t data) { memory.at(WX_addr) = data; }
uint8_t MMU::getWindowXRegister() { return memory.at(WX_addr); }
void MMU::setWindowYRegister(uint8_t data) { memory.at(WY_addr) = data; }
uint8_t MMU::getWindowYRegister() { return memory.at(WY_addr); }
uint8_t MMU::getScrollXRegister() { return memory.at(SCX_addr); }
uint8_t MMU::getScrollYRegister() { return memory.at(SCY_addr); }
...
bool MMU::isLCDDisplayEnabled() { return checkBit(7, memory.at(LCDC_addr)); }
...
bool MMU::isWindowTileMapSelectSet() { return checkBit(6, memory.at(LCDC_addr)); }
...
bool MMU::isWindowDisplayEnabled() { return checkBit(5, memory.at(LCDC_addr)); }
...
bool MMU::isTileDataSelectSet() { return checkBit(4, memory.at(LCDC_addr)); }
...
bool MMU::isBGTileMapSelectSet() { return checkBit(3, memory.at(LCDC_addr)); }
...
bool MMU::isTallSpriteSizeSet() { return checkBit(2, memory.at(LCDC_addr)); }
...
bool MMU::isSpritesEnabled() { return checkBit(1, memory.at(LCDC_addr)); }
...
bool MMU::isBGAndWindowEnabled() { return checkBit(0, memory.at(LCDC_addr)); }
...
bool MMU::isCoincidenceFlagSet() { return checkBit(2, memory.at(STAT_addr)); }
void MMU::setPPUMode(uint8_t mode) {
  memory.at(STAT_addr) = (memory.at(STAT_addr) & 0xFC) | mode;
}
uint8_t MMU::getPPUMode() { return memory.at(STAT_addr) & 0x03; }
...
void MMU::setCurrentScanLine(uint8_t data) { memory.at(LY_addr) = data; }
uint8_t MMU::getCurrentScanLine() { return memory.at(LY_addr); }
void MMU::incrementCurrentScanLine() { memory.at(LY_addr)++; }

bool MMU::isLYCEqualLY() { return memory.at(LY_addr) == memory.at(LYC_addr); }
